    ...
    def post(self, request, format='json', *args, **kwargs):
        ...
        if not patient.need_medication_noti_time_set() and len(patient.medication_noti_time_list()) != 0:
            ...
            if self.request.query_params.get('restart') == 'true':
                ...
                response.set_quick_replies_yes_or_no(
                    block_id_for_yes='5da68fb1ffa7480001db0361')  # (블록) 02-2 치료 관리 설정_복약 알림 시간대
...
#            print('time: ', time)
            next_undefined_number = patient.next_undefined_medication_noti_time_number()
#            print('next_undefined_number: ', next_undefined_number)
...
#            print('NOT need_medication_noti_time_set() ')
            if self.request.query_params.get('restart') == 'true':
#                print('need_medication_noti_time_set() 06 치료 : 치료관리안내')
                response.set_quick_replies_yes_or_no(
...
#                print('need_medication_noti_time_set() 03 치료 : 치료관리안내')
                response.set_quick_replies_yes_or_no(
...
#            print('need_medication_noti_time_set() ')
            ...
            if self.request.query_params.get('restart') == 'true':
                ...
                response.set_quick_replies_yes_or_no(
                    block_id_for_yes='5da5eac292690d0001a489e4')  # (블록) 03 치료 관리 설정_복약 알림 시작
