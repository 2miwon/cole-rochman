...
class PatientAdmin(GuardedModelAdmin, ImportExportModelAdmin):
    ...
    list_filter = [
        "hospital",
        "medication_manage_flag",
        "visit_manage_flag",
        "medication_noti_flag",
        "visit_notification_flag",
        "display_dashboard",
        "safeout",
        "treatment_end_date",
    ]
...
class NotificationRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ["patient__name", "patient__code"]
    actions = ["make_status_pending", "make_status_canceled"]
